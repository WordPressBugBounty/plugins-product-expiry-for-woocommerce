...
**Product Expiry for WooCommerce** gives every product and variation in your store an expiry date — and takes it from there. When the date hits, the plugin can flip the product to out-of-stock, move it to draft, or fire an email notification. No manual cleanup, no forgotten sale items haunting your catalog.
